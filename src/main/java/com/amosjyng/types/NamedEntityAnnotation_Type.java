...
public class NamedEntityAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.amosjyng.types.NamedEntityAnnotation");
  ...
  public String getNamedEntity(int addr) {
      ...
      jcas.throwFeatMissing("NamedEntity", "com.amosjyng.types.NamedEntityAnnotation");
